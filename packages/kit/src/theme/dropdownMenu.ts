...
export default (colors: Color[]) => ({
  slots: {
    content: 'min-w-32 max-w-[calc(100vw-1rem)] max-h-[calc(100vh-1rem)] bg-white rounded-lg border border-neutral-200 shadow-lg shadow-black/10 divide-y divide-neutral-200 overflow-y-auto',
    group: 'p-1',
