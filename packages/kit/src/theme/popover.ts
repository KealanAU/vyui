...
export default {
  slots: {
    content: 'flex flex-col max-w-[calc(100vw-1rem)] max-h-[calc(100dvh-1rem)] overflow-y-auto bg-white rounded-md border border-neutral-200 shadow-lg shadow-black/10 pointer-events-auto',
