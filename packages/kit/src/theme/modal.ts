...
export default {
  slots: {
    ...
    content: 'relative overflow-hidden bg-white divide-y divide-neutral-200 flex flex-col w-[calc(100vw-2rem)] max-w-lg max-h-[calc(100dvh-1rem)] rounded-lg border border-neutral-200',
