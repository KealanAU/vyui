...
export default (colors: Color[]) => ({
  slots: {
    root: 'relative group overflow-hidden bg-elevated rounded-lg border border-neutral-200 shadow-lg shadow-black/10 p-4 flex flex-row min-w-0 gap-2.5 w-[calc(100vw-2rem)] max-w-sm',
