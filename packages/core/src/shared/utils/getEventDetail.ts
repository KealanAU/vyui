...
//
// Ported from `lynx-family/lynx-ui` `packages/lynx-ui-common/src/utils/getEventDetail.ts`.

/**
 * A type representing event details that may contain layout and positioning
 * information. It includes optional properties for dimensions and coordinates,
 * and allows for other properties.
 */
 ...
 * @returns The `detail` or `params` object from the event, or an empty object
 *   if neither is found.
 */
