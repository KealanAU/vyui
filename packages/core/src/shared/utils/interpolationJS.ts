...
//
// Ported from `lynx-family/lynx-ui` `packages/lynx-ui-common/src/utils/interpolationJS.ts`.
 ...
 *
 * Background-thread (plain JS) variant. For the main-thread worklet variant
 * that carries the `'main thread'` directive, see `./interpolation`.
 *
