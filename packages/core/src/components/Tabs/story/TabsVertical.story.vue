  ...
  >
    <Variant title="default">
      ...
      >
        ...
        >
          <TabsIndicator class="absolute bg-violet11 right-0 w-[2px] top-0 h-[--vy-tabs-indicator-size] translate-y-[--vy-tabs-indicator-position] rounded-full  transition-[width,transform] duration-300" />
          <TabsTrigger
