  ...
  >
    <Variant title="default">
      ...
      >
        ...
        >
          <TabsIndicator class="absolute bg-violet11 left-0 h-[2px] bottom-0 w-[--vy-tabs-indicator-size] translate-x-[--vy-tabs-indicator-position] rounded-full  transition-[width,transform] duration-300" />
          <TabsTrigger
