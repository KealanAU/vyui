---
title: @vyui/core v0.0.4
description: Add NumberField — headless @vyui/core primitive (NumberFieldRoot / NumberFieldInput / NumberFieldIncrement / NumberFieldDecrement) with min/max/step, clamp/s…
date: 2026-06-01
package: core
version: v0.0.4
---
