...
The only theme variant is `disabled`, which dims the trigger and applies a disabled cursor style. The default theme is light-mode-oriented and uses a simple transition instead of named web accordion keyframes.
