...
These pages cover the ecosystem Vy UI sits in rather than Vy UI itself. If you already know what Lynx is and have decided to use Vue with it, the [component documentation](/components) and [Getting Started](/getting-started) are the more useful places to be.
