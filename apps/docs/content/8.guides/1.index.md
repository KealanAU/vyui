...
**Building a native app?** [Sparkling](/guides/sparkling) is an easy default for most Vue Lynx apps. It ships containers, routing, native bridge, and a dev workflow so you can avoid wiring a custom iOS or Android host.
::
