...
None of that is exotic. It is the normal cost of writing CSS for a native engine rather than for a browser, and it is paid once per library rather than once per application.
