...
::card-group
  ...
  to: /guides/sparkling
  ---
  The recommended native shell — containers, routing, and a bridge, with `run:ios` and `run:android`.
  :::
  ...
  ---
  Building a custom iOS host — the fallback when Sparkling is not enough.
  :::
