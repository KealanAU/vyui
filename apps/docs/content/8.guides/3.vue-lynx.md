...
These ship in the `XElement` pod on iOS and its Android equivalent, which the [Xcode guide](/guides/testing-with-xcode) covers. Leaving it out is a common first-run failure, since the components render empty and nothing is logged.
