...
**Lynx** is the native bundle a device loads, fetched both by a QR-code scan and by a [Sparkling shell](/guides/sparkling) or a [custom host app](/guides/testing-with-xcode).
...
| [Sparkling shell](/guides/sparkling) | Native modules, routing, bridge methods, release behavior | Nothing, at the cost of a native build |
| [Custom host in Xcode](/guides/testing-with-xcode) | Full control over the container, custom native modules | Nothing, at the cost of building the host from scratch |
