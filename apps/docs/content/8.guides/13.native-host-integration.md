...
For most apps, Sparkling handles integration of safe-area insets, theme, and global events automatically. The manual wiring on this page is needed only for custom native hosts.
::
