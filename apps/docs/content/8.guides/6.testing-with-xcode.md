...
**[Sparkling](/guides/sparkling) is an easy default for most apps.** It ships containers, routing, native bridge, and `npx sparkling run:ios` — everything below, already written. This guide remains for cases where you need full control over the container or want to understand the Lynx host seam from first principles.
::
...
::card-group
  ...
  to: /guides/sparkling
  ---
  An easy default — build your own host if you need more control.
  :::
