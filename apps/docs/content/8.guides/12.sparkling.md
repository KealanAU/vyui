...
Sparkling is the easiest path for most Vue Lynx apps. If you need full control or a smaller shell, building your own native host (see our [Xcode guide](/guides/testing-with-xcode)) is equally valid. For most apps, Sparkling's containers, routing, bridge, and dev workflow cover what you need.
